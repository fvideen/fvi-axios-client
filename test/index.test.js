...
describe('Testing Axios Client', () => {
    ...
    it('Init with config url=google.com, timeout and delay 1', done => {
        try {
            app({ url: 'http://google.com', timeout: 1, delay: 1 })
            done()
        } catch (e) {
            done(e)
        }
    ...
    it('Init with config url=google.com, timeout 1', done => {
        try {
            app({ url: 'http://google.com', timeout: 1 })
            done()
        } catch (e) {
            done(e)
        }
    ...
    it('Init with config url=google.com, delay 1', done => {
        try {
            app({ url: 'http://google.com', delay: 1 })
            done()
        } catch (e) {
            done(e)
        }
    ...
    it('Testing get with timeout 1000 and delay 10', done => {
        app({ url: 'http://google.com', timeout: 1000, delay: 10 })
            .get('/')
            .then(res => {
    ...
    it('Testing get with timeout 1000', done => {
        app({ url: 'http://google.com', timeout: 1000 })
            .get('/')
            .then(res => {
                chai.assert.exists(res.data, 'res.data is null!')
                done()
    ...
    it('Testing get with timeout 1', done => {
        app({ url: 'http://google.com', timeout: 1 })
            .get('/')
            .then(res => {
                done('Not should returns response!')
            })
            .catch(_e => done())
    })

    it('Testing get with delay 10', done => {
        try {
            app({ url: 'http://google.com', delay: 10 })
                .get('/')
                .then(res => {
                    chai.assert.exists(res.data, 'res.data is null!')
                    done()
    ...
    it('Testing get with delay 1', done => {
        try {
            app({ url: 'http://google.com', delay: 1 })
                .get('/')
                .then(res => {
